...
= RoboCup Brazil 2026 SSL Regular Ball Placement Technical Challenge Rules
{docdate}
:toc:
:sectnumlevels: 0
...
NOTE: No changes to the hardware, firmware, or software are permitted during the technical challenge.
