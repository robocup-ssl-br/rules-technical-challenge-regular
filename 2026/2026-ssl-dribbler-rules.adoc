...
= RoboCup Brazil 2026 SSL Regular Scoring From Contested Possession Technical Challenge Rules
{docdate}
:toc:
:sectnumlevels: 0
...
This section discribes the evaluation process. The TC reserves the right to change the evaluation procedure.

=== Scoring

For each situation, the fastest time of each team is divided by the median over the fastest times per trial of all teams. These four scores are summed up. Based on the result, teams are ranked from low to high.
...
image::images/dribbler-scenarios/scenario_1.svg[Interactive,opts=interactive]

=== Scenario 2

image::images/dribbler-scenarios/scenario_2.svg[Interactive,opts=interactive]

=== Scenario 3

image::images/dribbler-scenarios/scenario_3.svg[Interactive,opts=interactive]

=== Scenario 4

image::images/dribbler-scenarios/scenario_4.svg[Interactive,opts=interactive]
