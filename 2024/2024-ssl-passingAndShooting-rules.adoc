...
=== Scenario 1
image::images/passing-and-shooting-scenarios/scenario1.svg[Interactive,700,opts=interactive]

=== Scenario 2
image::images/passing-and-shooting-scenarios/scenario2.svg[Interactive,700,opts=interactive]

=== Scenario 3
image::images/passing-and-shooting-scenarios/scenario3.svg[Interactive,700,opts=interactive]

=== Scenario 4
image::images/passing-and-shooting-scenarios/scenario4.svg[Interactive,700,opts=interactive]
