...
=== Scenario 1
image::images/passing_and_shooting_scenarios/scenario1.svg[Interactive,700,opts=interactive]

=== Scenario 2
image::images/passing_and_shooting_scenarios/scenario2.svg[Interactive,700,opts=interactive]

=== Scenario 3
image::images/passing_and_shooting_scenarios/scenario3.svg[Interactive,700,opts=interactive]

=== Scenario 4
image::images/passing_and_shooting_scenarios/scenario4.svg[Interactive,700,opts=interactive]
