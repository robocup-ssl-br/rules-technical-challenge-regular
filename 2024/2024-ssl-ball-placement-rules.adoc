...
image::Scenarios/ball_placement_scenarios/scenario1.svg[Interactive,700,opts=interactive]

=== Scenario 2

image::Scenarios/ball_placement_scenarios/scenario2.svg[Interactive,700,opts=interactive]

=== Scenario 3

image::Scenarios/ball_placement_scenarios/scenario3.svg[Interactive,700,opts=interactive]

=== Scenario 4

image::Scenarios/ball_placement_scenarios/scenario4.svg[Interactive,700,opts=interactive]

=== Scenario 5

image::Scenarios/ball_placement_scenarios/scenario5.svg[Interactive,700,opts=interactive]

=== Scenario 6

image::Scenarios/ball_placement_scenarios/scenario6.svg[Interactive,700,opts=interactive]

=== Scenario 7

image::Scenarios/ball_placement_scenarios/scenario7.svg[Interactive,700,opts=interactive]

=== Scenario 8

image::Scenarios/ball_placement_scenarios/scenario8.svg[Interactive,700,opts=interactive]
