...
image::images/dribbler_scenarios/scenario_1.svg[Interactive,opts=interactive]

=== Scenario 2

image::images/dribbler_scenarios/scenario_2.svg[Interactive,opts=interactive]

=== Scenario 3

image::images/dribbler_scenarios/scenario_3.svg[Interactive,opts=interactive]

=== Scenario 4

image::images/dribbler_scenarios/scenario_4.svg[Interactive,opts=interactive]
